...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname |Pset 13|) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
...
(define SONGMSG-1 (list "SONG" 1 MD-1 THUG-LIFE))
(define SONGMSG-2 (list "SONG" 2 MD-2 TONYA))

#;
(define (songmsg-temp s)
  ... (first s) ... (second s) ... (metadata-temp (third s)) ... (fourth s) ...)
...
(define SERVERMSGSONG-1 (list "SONG" 1 MD-1 THUG-LIFE))
(define SERVERMSGSONG-2 (list "SONG" 2 MD-2 TONYA))
