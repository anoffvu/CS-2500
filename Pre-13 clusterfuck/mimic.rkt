...
(define MATTHIAS
  (symbols->strings
   '((Matthias Felleisen is a computer science professor and an author of German background)
     (He grew up in Germany and emigrated to the USA when he was 21 years old)
     (Felleisen is currently a Trustee Professor in the College of Computer and Information Science at Northeastern University in Boston Massachusetts)
     (In the past he has taught at Rice University after receiving his PhD from Indiana University under the direction of Daniel P Friedman)
     (Felleisens interests include programming languages including software tools program design software contracts and many more)
     ...
     (As part of this effort he authored How to Design Programs MIT Press 2001 with Findler Flatt and Krishnamurthi)
     ...
     (In 2012 he received the ACM SIGPLAN Programming Languages Achievement Award for significant and lasting contribution to the field of programming languages)
